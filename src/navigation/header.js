      ...
      <header className="absolute inset-x-0 top-0 z-50 fade">
        ...
        <nav className="relative flex items-center justify-between p-4 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
                <a href="/" className="transition-all ease-in-out duration-200 text-txt hover:text-head hover:-translate-y-1">
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
            ...
            <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto dark:bg-ft px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 menu">
