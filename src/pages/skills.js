      ...
      <Header />
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="mt-10 grid grid-cols-4 gap-10 justify-center items-center text-txt fade_left">
                ...
                <div class="mt-10 grid flex grid-cols-3 gap-20 justify-center items-center align-center text-txt fade_left">
                    {/* VS Code: */}
                    <div class="transition-all ease-in-out duration-200 hover:text-head grid grid-cols-2 flex justify-center">
